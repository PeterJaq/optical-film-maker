...
class DeepQNetwork:
    ...
    def _build_net(self):
        ...
        w_initializer, b_initializer = tf.compat.v1.random_normal_initializer(0., 0.3), tf.constant_initializer(0.1)

        # ------------------ build evaluate_net ------------------
        with tf.compat.v1.variable_scope('eval_net'):
            e1 = tf.compat.v1.layers.dense(self.s, 90, tf.compat.v1.relu, kernel_initializer=w_initializer,
        ...
        with tf.compat.v1.variable_scope('target_net'):
            t1 = tf.compat.v1.layers.dense(self.s_, 90, tf.compat.v1.nn.relu, kernel_initializer=w_initializer,
        ...
        with tf.compat.v1.variable_scope('q_eval'):
            a_indices = tf.compat.v1.stack([tf.compat.v1.range(tf.compat.v1.shape(self.a)[0], dtype=tf.int32), self.a], axis=1)
